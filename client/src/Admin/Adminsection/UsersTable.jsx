        ...
        <table className="w-full text-left">
          <thead className="bg-gray-50/50">
            <tr>
              ...
              <th className="px-8 py-6 text-[10px] font-black text-gray-400 uppercase tracking-widest">Role Clearance</th>
              ...
              <tr key={user._id} className="hover:bg-gray-50/50 transition-colors">
                ...
                <td className="px-8 py-6">
                  <select
                    ...
                    className="bg-transparent font-black text-[10px] uppercase tracking-widest text-violet-600 border-none focus:ring-0 cursor-pointer outline-none"
                  >
                    <option value="user">Premium Member</option>
                    <option value="admin">Curator Admin</option>
                  </select>
                </td>
                <td className="px-8 py-6">
