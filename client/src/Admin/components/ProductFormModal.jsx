    ...
    >
      <div className="space-y-8">
        <div className="grid grid-cols-2 gap-8">
          <div className="col-span-2">
            ...
            <input
              ...
              className="w-full bg-gray-50 border-gray-100 rounded-2xl px-6 py-4 font-bold focus:ring-violet-600 focus:border-violet-600 transition-all"
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-50 border-gray-100 rounded-2xl px-6 py-4 font-bold focus:ring-violet-600 transition-all"
            />
          </div>
          <div>
          ...
          <div className="col-span-2">
            ...
            <input
              ...
              className="w-full bg-gray-50 border-gray-100 rounded-2xl px-6 py-4 text-xs font-mono focus:ring-violet-600 transition-all"
              placeholder="https://..."
            />
          </div>
          <div>
            ...
            <select
              ...
              className="w-full bg-gray-50 border-gray-100 rounded-2xl px-6 py-4 font-bold focus:ring-violet-600 appearance-none"
            >
        ...
        <div className="pt-4">
          ...
          >
            {loading ? "Synchronizing..." : "Finalize Asset Creation"}
          </button>
        </div>
      </div>
    </Modal>
